...
<script type="text/javascript">
  ...
  var timestamp = (new Date()).valueOf();
             var requestURL = "pay.php?uid=" + x.userRoleId +  "&serverid=" + x.userServer + "&rechargeid=" + x.goodsId ;
...
echo 'function _LoginToken(callback) {
	       egret.localStorage.setItem("account", "'.$openid.'");
			if (callback) {
				callback("'.$openid.'")
			}	
	}';	
